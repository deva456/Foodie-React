    ...
    <section id="contact" className="md:mt-10 lg:my-8 lg:mx-10 about-scroll">
      ...
      <div className="flex lg:mx-[20%] my-5 md:my-8 gap-7 justify-between flex-col md:flex-row">
        ...
        <div className="flex flex-col gap-2 w-full md:w-fit">
          ...
          <article className="bg-green-100 border-2 border-green-400 hover:shadow-md flex flex-col items-center w-full md:w-65 p-7 lg:p-5 text-lg rounded-md">
            <MdOutlineEmail className="contact__option-icon" />
            <h4 className="font-bold">Email</h4>
            <h5 className="font-medium text-base">devashishkapadnis075@gmail.com</h5>
            <a href="mailto:devashishkapadnis075@gmail.com" target="_blank" className="text-sm hover:text-green-700 font-medium">
              Send a message
            </a>
          </article>
